...
{ 
    ...
    numHorizontalTangents = 11.5,//number of horizontal tangents(lobes) to the curve 
    numVerticalTangents = 11.5,//number of vertical tangents(lobes) to the curve 
    relativeWidth  = 300,//default relative width of the curve to the height
    relativeHeight = 300;//default relative height of the curve to the width  
